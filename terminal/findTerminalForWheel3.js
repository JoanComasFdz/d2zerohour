...
function findTerminalForWheel3(singe, firstConsoleNumber, secondConsoleNumber, data, firstConsoleLeftValue, firstConsoleRightValue, secondConsoleValue, useLeftValueForThirdWheel) {
  ...
  console.info(`Finding terminal for second console pair '${firstConsolePair}' with third wheel number '${wheelNumber}' and splitting position '${positionWhenSpliting}'...`)
