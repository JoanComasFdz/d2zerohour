function activateValuesInThirdWheel(secondConsoleNumber, secondConsolePairs, wheelNumber, positionWhenSpliting) {
  ...
  for (let i = 0; i < secondConsolePairs.length; i++) {
    ...
    $(`#${singe}-console1${secondConsoleNumber} #w${wheelNumber}li${valueToActivate}`).removeClass("overlay");
